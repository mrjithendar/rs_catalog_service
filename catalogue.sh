...
echo -e "\e[1;33mDownloading and extracting the artifacts\e[0m"
...
if [ $? -ne 0 ]; then
    ...
    echo -e "\e[1;33mBuild tools installed successfully\e[0m"
    else
        echo -e "\e[1;31mBuild tools existing installation found\e[0m"
fi
...
if [ $? -eq 0 ]; then
    echo -e "\e[1;33mNPM packages installed successfully\e[0m"
        ...
        echo -e "\e[1;31mNPM packages failed to install\e[0m"
        exit 1
fi
